    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <li class="mt">
          ...
          <li class="sub-menu">
            <a  class="active" href="/Projek/rab-user/index copy.php">
              <i class="fa fa-th"></i>
      ...
      <h2></i>RAB</h2>
            ...
            <table class="table table-striped table-bordered table-hover" id="tb-mahasiswa">
                <thead>
                    <tr>
                        <th>No</th>
                        <th><center>Nama Unit Kerja</center></th>
                ...
                <?php
                    ...
                    $query = "select * from rab1 order by nama_unit_kerja asc";
                    ...
                    if($data->num_rows <= 0){
                        ...
                        while($row = $data->fetch_assoc()){
                            ...
                            <tr>
                              ...
                              <td align="center">'.$row['nama_unit_kerja'].'</td>
