                ...
                <?php
                    ...
                    if($data->num_rows <= 0){
                        ...
                        while($row = $data->fetch_assoc()){
                            echo "<tr>";
                            echo "<td>".$no++."</td>";
                            echo "<td class='center'>".$row['nidn']."</td>";
                            echo "<td>".$row['nip']."</td>";
                            echo "<td>".$row['nama']."</td>";
                            echo "<td>".$row['ttl']."</td>";
                            ...
                            echo '<td class="text-center"><a href="form-edit.php?nidn='.$row['nidn'].'" class="btn btn-info btn-xs"><i class="fa fa-pencil">edit</i></a>';
                            echo ' <a href="hapus.php?nidn='.$row['nidn'].'" class="btn btn-danger btn-xs"><i class="fa fa-trash">hapus</i></a></td>';
                            echo "</tr>";
                        }
                    }
                ?>
