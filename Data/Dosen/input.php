        ...
        <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="buttons.html">Admin</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="/projek/data/dosen/index.php">Dosen</a></li>
            </ul>
          </li>
          <li class="sub-menu">
      ...
      <div class="row">
        ...
        <form id="inputmahasiswa" class="form-horizontal" method="post" action="simpan.php">
            ...
            <div class="form-group">
                <label for="username" class="col-sm-2 control-label">NIDN</label>
                <div class="col-sm-4">
                <input type="text" class="form-control" id="nidn" name="nidn" placeholder="Masukan NIDN" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="date" class="col-sm-2 control-label">Tempat, Tanggal Lahir</label>
                <div class="col-sm-4">
                <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Masukan Tempat, Tanggal Lahir" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                <input type="text" class="form-control" id="pangkat" name="pangkat" placeholder="Masukan Pangkat" required>
                </div>
            </div>
